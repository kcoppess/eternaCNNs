...
batch_size = 32
save = True
filename = '/scratch/users/kcoppess/results/base1D'


conv_w_shapes = [ [5, 5, 1, c], \
        [5, 5, c, c], \
        [5, 5, c, c], \
        [5, 5, c, c], \
        [2, 5, c, c], \
...
print 'loading data...'
all_inputs = np.loadtxt('/scratch/users/kcoppess/processed/small/onebase_features.csv', delimiter=',') #pd.read_csv('pairmap2D.csv', delimiter=',', header=None, nrows=Ntrain)
all_labels = np.loadtxt('/scratch/users/kcoppess/processed/small/bases.csv', delimiter=',') #pd.read_csv('loops.csv', delimiter=',', header = None, nrows=Ntrain)
